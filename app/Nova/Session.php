...
class Session extends Resource {
  ...
  public function fields(Request $request) {
    return [
      ...
      Select::make('Tariff')->options(\App\Models\Session::tariffEnum()->mapWithKeys(function ($item) {return [$item => $item];})),

      Select::make('Status')->options(\App\Models\Session::statusEnum()->mapWithKeys(function ($item) {return [$item => $item];})),
